          ...
          <el-row :span="24" class="row-1">
            ...
            <el-col :span="12">
              <el-form-item label="分数">
                <el-input v-model="SingleQues.score" auto-complete="off"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    analysData() {
      ...
      this.SingleQues.score = this.currentItem.score;
    ...
    onSubmit() {
      ...
      sendpkg.score = parseInt(this.SingleQues.score);
      sendpkg.examId = this.examId;
      sendpkg.e_id = this.enterprise.e_id;
      console.log(sendpkg);
      this.$http.post(`http://127.0.0.1:7001/examjudge`, sendpkg).then(res => {
        console.log(res);
        this.$emit('fetch');
        this.SingleQues = this.cloneObj(this.SingleQuesb);
      })
